...
| autoscaling.metrics                | metrics used for autoscaling for clusters that support autoscaling/v2beta2`           | See [values.yaml](development/github/gateway-poc/kong/charts/kong/values.yaml) |
...
> **Tip**: You can use the default [values.yaml](development/github/gateway-poc/kong/charts/kong/values.yaml)
